...
pub struct VMTRenderable {
    _pad1: [u8; 4 * 9],
    pub get_model: cfn!(&'static Model, *const Renderable),
    _pad2: [u8; 4 * 6],
    pub setup_bones: cfn!(
        bool,
        *const Renderable,
    ...
    _pad3: [u8; 4 * 17],
    pub renderable_to_world_transform: cfn!(*mut Matrix3x4, *const Renderable),
}
...
pub struct ModelRenderInfo {
    ...
    model: *const Model,
    model_to_world: *const Matrix3x4,
    lighting_offset: *const Matrix3x4,
    lighting_origin: *const Vector3,
    flags: c_int,
    entity_index: c_int,
    skin: c_int,
    body: c_int,
...
pub struct VMTModelRender {
    _pad1: [u8; 4 * 1],
    pub forced_material_override: cfn!(c_void, *mut ModelRender, *const IMaterial, c_int),
    _pad2: [u8; 4 * 17],
